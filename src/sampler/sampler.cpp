...
void Sampler::SetNoteVolume_Midi( uint8_t data1) {
...
void Sampler::SetNotePan_Midi( uint8_t data1) {
  /*
...
void Sampler::SetNoteDecay_Midi( uint8_t data1) {
  /*
...
void Sampler::SetNoteOffset_Midi( uint8_t data1) {
  /*
...
void Sampler::SetSoundPitch_Midi( uint8_t data1) {
  /*
