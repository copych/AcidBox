...
void TeeBeeFilter::calculateCoefficientsExact()
{
...
void TeeBeeFilter::calculateCoefficientsApprox4()
{
  // calculate intermediate variables:
  float wc  = twoPiOverSampleRate * cutoff;
  float wc2 = wc * wc;
...
void TeeBeeFilter::sinCos(float x, float* sinResult, float* cosResult)
{
  ...
  *cosResult = c;
  ...
  float TeeBeeFilter::shape(float x)
  {
