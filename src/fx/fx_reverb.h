...
inline void FxReverb::Process(float *signal_l, float *signal_r) {
    float inSample;
...
inline void FxReverb::SetLevel(float value) {
    rev_level = value;
#ifdef DEBUG_FX
...
inline float FxReverb::Do_Comb0(float inSample) {
...
inline float FxReverb::Do_Comb1(float inSample) {
...
inline float FxReverb::Do_Comb2(float inSample) {
...
inline float FxReverb::Do_Comb3(float inSample) {
...
inline float FxReverb::Do_Allpass0(float inSample) {
...
inline float FxReverb::Do_Allpass1(float inSample) {
...
inline float FxReverb::Do_Allpass2(float inSample) {
