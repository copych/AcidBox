...
void FxReverb::Process( float *signal_l, float *signal_r ) {
    float inSample;
...
void FxReverb::SetTime(float value) {
...
void FxReverb::SetLevel(float value) {
    rev_level = value;
#ifdef DEBUG_FX
...
float FxReverb::Do_Comb0(float inSample) {
...
float FxReverb::Do_Comb1(float inSample) {
...
float FxReverb::Do_Comb2(float inSample) {
...
float FxReverb::Do_Comb3(float inSample) {
...
float FxReverb::Do_Allpass0(float inSample) {
...
float FxReverb::Do_Allpass1(float inSample) {
...
float FxReverb::Do_Allpass2(float inSample) {
